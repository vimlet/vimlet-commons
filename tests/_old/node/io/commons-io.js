...
async function run() {
    ...
    var files = await commons.io.getFiles([include, include2], [exclude, exclude2]);
    ...
    console.log("Estoy en pattern", await commons.io.isInPattern("resources/test1/folder2.js.md", "resources/test1/**/*.*"));
    console.log("NO estoy en pattern", await commons.io.isInPattern("resources/test1/peter.md", "resources/test1/**/*.*"));
